...
'''
This is the GNU Radio MMWAVE_BEAM_CONTROL module. Place your Python package
...
# import swig generated symbols into the mmwave_beam_control namespace
try:
    # this might fail if the module is python-only
    from .mmwave_beam_control_swig import *
