...
class fixes_collection(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, center_freq=5.3e9, fft_len=64, rx_gain=0, samp_rate=2e6, tx_gain=0.700):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fixes_collection")
        ...
        self.csv_name = csv_name = "new_fixes_static.csv"
        ...
        self.mmwave_beam_recog_recog_ofdm_receiver_0 = mmwave_beam_recog.recog_ofdm_receiver(
            ...
            debug_log=False,
            scramble_bits=False)
        self.mmwave_beam_recog_dump_snr_rsrp_to_csv_0 = mmwave_beam_recog.dump_snr_rsrp_to_csv( csv_name, label_name, fft_len, "simple", 10, samp_rate//2, sync_word2, False)
        ...
        self.mmwave_beam_control_manual_beam_0 = mmwave_beam_control.manual_beam(tx_range, rx_range, False)
    ...
    def set_tx_range(self, tx_range):
        ...
        self.mmwave_beam_control_manual_beam_0.set_tx_beam(self.tx_range)
    ...
    def set_rx_range(self, rx_range):
        ...
        self.mmwave_beam_control_manual_beam_0.set_rx_beam(self.rx_range)
...
def main(top_block_cls=fixes_collection, options=None):
    if options is None:
