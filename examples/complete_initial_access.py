...
class complete_initial_access(gr.top_block, Qt.QWidget):

    def __init__(self, beam_period=0.1, center_freq=5.3e9, fft_len=64, file_suffix='angle_190', ia_interval=1, meas_period=1e-3, rx_gain=1, samp_rate=2e6, tx_gain=0.700):
        ...
        self.settings = Qt.QSettings("GNU Radio", "complete_initial_access")
        ...
        # Variables
        ##################################################
        self.tx_beams = tx_beams = [x for x in range(1,64)]
        self.sync_word2 = sync_word2 = [0j, 0j, 0j, 0j, 0j, 0j, (-1+0j), (-1+0j), (-1+0j), (-1+0j), (1+0j), (1+0j), (-1+0j), (-1+0j), (-1+0j), (1+0j), (-1+0j), (1+0j), (1+0j), (1 +0j), (1+0j), (1+0j), (-1+0j), (-1+0j), (-1+0j), (-1+0j), (-1+0j), (1+0j), (-1+0j), (-1+0j), (1+0j), (-1+0j), 0j, (1+0j), (-1+0j), (1+0j), (1+0j), (1+0j), (-1+0j), (1+0j), (1+0j), (1+0j), (-1+0j), (1+0j), (1+0j), (1+0j), (1+0j), (-1+0j), (1+0j), (-1+0j), (-1+0j), (-1+0j), (1+0j), (-1+0j), (1+0j), (-1+0j), (-1+0j), (-1+0j), (-1+0j), 0j, 0j, 0j, 0j, 0j]
        self.sync_word1 = sync_word1 = [0., 0., 0., 0., 0., 0., 0., 1.41421356, 0., -1.41421356, 0., 1.41421356, 0., -1.41421356, 0., -1.41421356, 0., -1.41421356, 0., 1.41421356, 0., -1.41421356, 0., 1.41421356, 0., -1.41421356, 0., -1.41421356, 0., -1.41421356, 0., -1.41421356, 0., 1.41421356, 0., -1.41421356, 0., 1.41421356, 0., 1.41421356, 0., 1.41421356, 0., -1.41421356, 0., 1.41421356, 0., 1.41421356, 0., 1.41421356, 0., -1.41421356, 0., 1.41421356, 0., 1.41421356, 0., 1.41421356, 0., 0., 0., 0., 0., 0.]
        self.rx_beams = rx_beams = [x for x in range(1,64)]
        ...
        self.mmwave_beam_control_rate_measure_0 = mmwave_beam_control.rate_measure("/home/adrian/rate_meas_" + file_suffix + ".log", 1e-3, False)
        self.mmwave_beam_control_kpi_agg_0 = mmwave_beam_control.kpi_agg("/home/adrian/kpi_beam_" + file_suffix + ".log", "/home/adrian/kpi_meas_" + file_suffix + ".log", False, meas_period, -90.0, True)
        self.mmwave_beam_control_beam_sweep_0 = mmwave_beam_control.beam_sweep(False, tx_beams, rx_beams, beam_period, ia_interval, True)
        self.mmwave_beam_control_beam_selector_0 = mmwave_beam_control.beam_selector("/home/adrian/sel_pair_" + file_suffix + ".log", "/home/adrian/sel_kpi_" + file_suffix + ".log", 0.0, True)
        self.mmwave_beam_control_beam_mapper_0 = mmwave_beam_control.beam_mapper(
          tx_mhu='MHU1',
          rx_mhu='MHU2',
          backoff=2e-6,
          pulse=2e-6,
          config_path='/home/adrian/Documents/gr-mmwave_beam_control/examples/interdigital_mhuv3.json',
          debug=True
        )
        ...
        self.connect((self.blocks_throttle_0, 0), (self.mmwave_beam_control_rss_calc_0_0, 0))
    ...
    def set_beam_period(self, beam_period):
        self.beam_period = beam_period
        self.mmwave_beam_control_beam_sweep_0.set_beam_period(self.beam_period)
    ...
    def set_ia_interval(self, ia_interval):
        self.ia_interval = ia_interval
        self.mmwave_beam_control_beam_sweep_0.set_ia_interval(self.ia_interval)
...
def argument_parser():
    ...
    parser.add_argument(
        "--beam-period", dest="beam_period", type=eng_float, default="100.0m",
        help="Set beam_period [default=%(default)r]")
    parser.add_argument(
        "--fft-len", dest="fft_len", type=intx, default=64,
        help="Set fft_len [default=%(default)r]")
    parser.add_argument(
        "--file-suffix", dest="file_suffix", type=str, default='angle_190',
        help="Set file_suffix [default=%(default)r]")
    parser.add_argument(
        "--ia-interval", dest="ia_interval", type=eng_float, default="1.0",
...
def main(top_block_cls=complete_initial_access, options=None):
    if options is None:
