...
class manual_beam_control(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, center_freq=5.3e9, fft_len=64, rx_gain=0, samp_rate=2e6, tx_gain=0.700):
        ...
        self.mmwave_beam_control_manual_beam_0 = mmwave_beam_control.manual_beam(tx_range, rx_range, True)
        self.mmwave_beam_control_beam_mapper_0 = mmwave_beam_control.beam_mapper('MHU1', 'MHU2', 2e-6, 2e-6, True)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.mmwave_beam_control_beam_mapper_0, 'gpio_cmd'), (self.blocks_message_debug_0, 'print'))
